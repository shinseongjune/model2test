		...
		<form method="post">
			<table>
				...
				<tr>
					...
					<td>
					<a href="dogCartQtyUp.do?kind=${cart.kind }" style="text-decoration: none; color:black;">
					▲</a><br />
					${cart.qty }<br />
					<a href="javascript:checkQty('${cart.kind }', ${cart.qty })" style="text-decoration: none; color:black;">
					▼</a>
					</td>
				</tr>
				</c:forEach>
				<tr>
					<td colspan="5" style="text-align:centerl">
					총 금액 : ${totalMoney }원
					</td>
				</tr>
				<tr>
